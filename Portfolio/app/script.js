...
request.open('GET', 'https://api.themoviedb.org/3/movie/top_rated?api_key=d3f09dc36b7dfd2241af1d67612a5679&language=en-US&page=1', true);
...
function createEmelents(movies) {
	for (var i = 0; i < movies.length; i++) {
		...
		// Zemiau kodas neveikia ant visu Internet Exlorer
 		/* var newElContent = `
